...
The goal of CEA is to maximize health benefits produced from a given level of resources. Therefore, it is consistent with welfare economics concept of Pareto efficiency \citep{birch1992cost} (Fig).
...
\hypertarget{cost-effectiveness-in-practive}{%
\subsection{Cost-effectiveness in practive}\label{cost-effectiveness-in-practive}}
